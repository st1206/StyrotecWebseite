<script lang="ts">
	...
	import arbeitsraum from '$lib/assets/images/portalfraesmaschinen/action.jpg';
	import action from '$lib/assets/images/portalfraesmaschinen/action.jpg';
	...
	import top from '$lib/assets/images/portalfraesmaschinen/fs15.jpg';
...
<div class="relative">
	...
	<img src={top} alt="FS15 Titelbild" class="h-[300px] w-full object-cover lg:h-[700px]" />
	<div
...
<div class="relative text-xl">
	...
	>
		<div>
			...
			<p class="text-justify">{$_(`fs15.übersicht-text`)}</p>
			<ul class="py-2">
				<li>● {$_(`fs15.übersicht-punkt1`)}</li>
				<li>● {$_(`fs15.übersicht-punkt2`)}</li>
				<li>● {$_(`fs15.übersicht-punkt3`)}</li>
			</ul>
			<p>{$_(`fs15.übersicht-ende`)}</p>
		</div>
	</div>
			...
			{#each fs15s as fs15}
				...
				>
					...
					<div class="flex flex-col justify-around xl:flex-row">
						...
						<div class="relative left-10 w-[80%] p-4 xl:left-0 xl:top-0 xl:w-[40%]">
