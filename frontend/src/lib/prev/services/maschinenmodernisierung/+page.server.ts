...
import type { ApiKategorieBilderKategorieBilder } from '$lib/types/cmsTypes/contentTypes';
...
export const load: PageServerLoad = async ({ fetch, cookies }) => {
	const loadKategorieBilder = async (): Promise<
		AttributesOf<ApiKategorieBilderKategorieBilder>[]
	> => {
