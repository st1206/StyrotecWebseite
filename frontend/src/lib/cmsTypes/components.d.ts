...
export interface PageComponentsCollectionTypeCards extends Struct.ComponentSchema {
...
export interface PageComponentsExploreMore extends Struct.ComponentSchema {
	...
	attributes: {
		description: Schema.Attribute.Text;
		previewCards: Schema.Attribute.Component<'partial-components.preview-card', true> &
			Schema.Attribute.Required;
...
export interface PageComponentsExploreVariants extends Struct.ComponentSchema {
	...
	attributes: {
		sectionTitle: Schema.Attribute.String & Schema.Attribute.Required;
		variantCards: Schema.Attribute.Component<'partial-components.variant-card', true> &
			Schema.Attribute.Required;
	};
}
...
export interface PageComponentsHeroDualImage extends Struct.ComponentSchema {
	...
	attributes: {
		heroTextImage: Schema.Attribute.Component<'page-components.basic-text-image', false> &
			Schema.Attribute.Required;
...
export interface PageComponentsHeroMedia extends Struct.ComponentSchema {
	...
	attributes: {
		...
		imageCards: Schema.Attribute.Component<'partial-components.image-card', true>;
		media: Schema.Attribute.Media<'files' | 'videos' | 'images'> & Schema.Attribute.Required;
		title: Schema.Attribute.String & Schema.Attribute.Required;
	};
}
...
export interface PageComponentsHistory extends Struct.ComponentSchema {
	...
	attributes: {
		historyEntries: Schema.Attribute.Component<'partial-components.history-entry', true> &
			Schema.Attribute.Required;
		sectionTitle: Schema.Attribute.String;
	};
}
...
export interface PartialComponentsAccordion extends Struct.ComponentSchema {
	...
	attributes: {
		accordionItems: Schema.Attribute.Component<'partial-components.accordion-item', true> &
			Schema.Attribute.Required;
		sectionTitle: Schema.Attribute.String;
		sortOrder: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<1>;
		title: Schema.Attribute.String & Schema.Attribute.Required;
	};
}
...
export interface PartialComponentsContentAccordion extends Struct.ComponentSchema {
	...
	attributes: {
		accordions: Schema.Attribute.Component<'partial-components.accordion', true> &
			Schema.Attribute.Required;
		sortOrder: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<1>;
...
export interface PartialComponentsContentImages extends Struct.ComponentSchema {
	...
	attributes: {
		images: Schema.Attribute.Media<'images' | 'files', true> & Schema.Attribute.Required;
		sortOrder: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<1>;
		title: Schema.Attribute.String;
	};
}
...
export interface PartialComponentsContentTextImage extends Struct.ComponentSchema {
	...
	attributes: {
		content: Schema.Attribute.Text & Schema.Attribute.Required;
		image: Schema.Attribute.Media<'images' | 'files'>;
		imagePosition: Schema.Attribute.Enumeration<['top', 'bottom', 'left', 'right']> &
...
export interface PartialComponentsDefaultCard extends Struct.ComponentSchema {
	...
	attributes: {
		...
		redirectButtons: Schema.Attribute.Component<'partial-components.redirect-button', true>;
...
export interface PartialComponentsProductDataSheet extends Struct.ComponentSchema {
...
export interface PartialComponentsPreviewCard extends Struct.ComponentSchema {
	...
	attributes: {
		...
		isImageTransparent: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
		redirectSlug: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
		subtitle: Schema.Attribute.String;
...
export interface PartialComponentsRedirectButton extends Struct.ComponentSchema {
...
export interface PartialComponentsTable extends Struct.ComponentSchema {
	...
	attributes: {
		sortOrder: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.DefaultTo<1>;
		tableColumns: Schema.Attribute.Component<'partial-components.table-column', true> &
			Schema.Attribute.Required;
		title: Schema.Attribute.String & Schema.Attribute.Required;
	};
}
...
export interface PartialComponentsTableColumn extends Struct.ComponentSchema {
	...
	attributes: {
		...
		tableRows: Schema.Attribute.Component<'partial-components.table-row', true> &
			Schema.Attribute.Required;
	};
}
...
export interface PartialComponentsTextImage extends Struct.ComponentSchema {
	...
	attributes: {
		accordions: Schema.Attribute.Component<'partial-components.accordion-item', true> &
			Schema.Attribute.Required;
		sectionTitle: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface PartialComponentsVariantAccordionItem extends Struct.ComponentSchema {
...
export interface PartialComponentsVariantAccordionItemLine extends Struct.ComponentSchema {
...
export interface PartialComponentsVariantCard extends Struct.ComponentSchema {
	...
	attributes: {
		accordionItems: Schema.Attribute.Component<'partial-components.variant-accordion-item', true> &
			Schema.Attribute.Required;
		image: Schema.Attribute.Media<'images' | 'files'> & Schema.Attribute.Required;
		title: Schema.Attribute.String & Schema.Attribute.Required;
	};
