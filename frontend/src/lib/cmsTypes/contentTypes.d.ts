...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
	...
	attributes: {
		blocks: Schema.Attribute.DynamicZone<['shared.media', 'shared.quote', 'shared.rich-text']>;
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiAnwenderstorieAnwenderstorie extends Struct.CollectionTypeSchema {
	...
	attributes: {
		Bilder: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
			Schema.Attribute.Required &
		...
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::anwenderstorie.anwenderstorie'>;
		publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBerichteBerichte extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::berichte.berichte'>;
		publishedAt: Schema.Attribute.DateTime;
		Titel: Schema.Attribute.String &
			Schema.Attribute.Required &
			Schema.Attribute.Unique &
...
export interface ApiFs10Fs10 extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		Titel: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiFs15Fs15 extends Struct.CollectionTypeSchema {
	collectionName: 'fs_15s';
	info: {
		description: '';
		displayName: 'FS15';
		pluralName: 'fs-15s';
	...
	attributes: {
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::fs-15.fs-15'> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
		Steuerung: Schema.Attribute.String & Schema.Attribute.Required;
		Titel: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
...
export interface ApiFs20Fs20 extends Struct.CollectionTypeSchema {
	collectionName: 'fs_20s';
	info: {
		description: '';
		displayName: 'FS20';
		pluralName: 'fs-20s';
	...
	attributes: {
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::fs-20.fs-20'> &
			Schema.Attribute.Private;
		publishedAt: Schema.Attribute.DateTime;
		Steuerung: Schema.Attribute.String & Schema.Attribute.Required;
		Titel: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
	...
	attributes: {
		carousel: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios', true> &
			Schema.Attribute.Required;
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiKategorieBilderKategorieBilder extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::kategorie-bilder.kategorie-bilder'>;
		publishedAt: Schema.Attribute.DateTime;
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
	};
...
export interface ApiKonventionelleKonventionelle extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::konventionelle.konventionelle'>;
		publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMaschineMaschine extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		Ansprechpartner: Schema.Attribute.Enumeration<
			['Martin Sch\u00FCtze', 'Tobias Schuster', 'Rolf R\u00F6hm', 'Norbert Schuster']
		> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
		...
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::maschine.maschine'>;
		...
		Zustand: Schema.Attribute.Enumeration<
			['gebraucht', 'gebraucht, gut', 'gebraucht, sehr gut', '\u00FCberholt', 'neu']
		> &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
...
export interface ApiMessenMessen extends Struct.CollectionTypeSchema {
	collectionName: 'messens';
	info: {
		description: '';
		displayName: 'Messen';
		pluralName: 'messens';
	...
	attributes: {
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::messen.messen'>;
		Messeanfang: Schema.Attribute.Date &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		Messeende: Schema.Attribute.Date &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		Messestand: Schema.Attribute.String &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
...
export interface ApiMetallpresseMetallpresse extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::metallpresse.metallpresse'> &
			Schema.Attribute.Private;
...
export interface ApiMitarbeiterMitarbeiter extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		locale: Schema.Attribute.String & Schema.Attribute.Private;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::mitarbeiter.mitarbeiter'> &
			Schema.Attribute.Private;
...
export interface ApiReferenzenReferenzen extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::referenzen.referenzen'>;
...
export interface ApiVorratsmaschineVorratsmaschine extends Struct.CollectionTypeSchema {
	...
	attributes: {
		...
		AbmessungUmhausung: Schema.Attribute.String &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		locale: Schema.Attribute.String;
		localizations: Schema.Attribute.Relation<'oneToMany', 'api::vorratsmaschine.vorratsmaschine'>;
		publishedAt: Schema.Attribute.DateTime;
		...
		updatedAt: Schema.Attribute.DateTime;
		updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		VorschubX: Schema.Attribute.String &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		VorschubY: Schema.Attribute.String &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
		...
		VorschubZ: Schema.Attribute.String &
			Schema.Attribute.Required &
			Schema.Attribute.SetPluginOptions<{
				i18n: {
					localized: true;
