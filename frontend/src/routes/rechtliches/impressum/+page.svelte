<div> <h3>Impressum</h3>
    ...
    <h2>Kontakt</h2>
    <p>
        Telefon: 0751 5605020 <br>
        E-Mail: info@styrotec.com
    </p>
    
    <h2>Registereintrag</h2>
    <p>
        Eintragung im Handelsregister. <br>
        Registergericht: Handelsregister Ulm<br>
        Registernummer: HRA 551449
    </p>
    ...
    <p>
        Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: <a href="https://ec.europa.eu/consumers/odr">weiter zur Webseite</a>. <br>
    ...
    <p><a href="http://fotolia.de"> Fotolia</a>, <a href="http://istockphoto.de">Istockphoto</a> </p>
