									...
									<table class="bg-secondary/15 block text-md p-4 w-full border border-secondary/25 ">
										<tbody >
											<tr class="w-[100%]">
												...
												<td class="w-[45%] text-right">{fs20.xAchse}</td>
											</tr>
											<tr>
												<td class="text-left">{$_(`cnc-Masch-Seite.yachse`)}</td>
												<td class="text-right">{fs20.yAchse}</td>
											</tr>
											<tr>
												<td class="text-left">{$_(`cnc-Masch-Seite.zachse`)}</td>
												<td class="text-right">{fs20.zAchse}</td>
											</tr>
										</tbody>
									</table>
								</Accordion.Content>
									...
									<table class="bg-secondary/15 text-md block p-4 border border-secondary/25">
										<tbody class="text-left">
											<tr>
												...
												<td class="w-[50%] text-right">{fs20.VorschubX}</td>
											</tr>
											<tr>
												<td>{$_(`cnc-Masch-Seite.vorschub-y`)}</td>
												<td class="w-[50%] text-right">{fs20.VorschubY}</td>
											</tr>
											<tr>
												<td>{$_(`cnc-Masch-Seite.vorschub-z`)}</td>
												<td class="w-[50%] text-right">{fs20.VorschubZ}</td>
											</tr>
										</tbody>
									</table>
								</Accordion.Content>
									...
									<table class="bg-secondary/15 text-md block p-4 border border-secondary/25">
										<tbody class="text-left">
											<tr>
												...
												<td class="w-[50%] text-right">{fs20.aAchse}</td>
											</tr>
											<tr>
												<td>{$_(`cnc-Masch-Seite.cachse`)}</td>
												<td class="w-[50%] text-right">{fs20.cAchse}</td>
											</tr>
										</tbody>
									</table>
								</Accordion.Content>
							...
							<Accordion.Item value="item-4">
								...
								<Accordion.Content class="pt-4 xl:text-xl mx-1">
									<table class="bg-secondary/15 text-md block p-4 border border-secondary/25">
										<tbody class="text-left">
											<tr>
												<td class="w-[50%] text-left">{fs20.Steuerung}</td>
											</tr>
										</tbody>
									</table>
								</Accordion.Content>
