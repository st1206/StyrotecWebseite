...
<div>
    ...
    <img
		class="relative z-10 size-full object-cover h-[600px]"
		src={portalfraes}
		alt="bild"
	/>
	<div class="relative -top-[20px] w-full h-[70px] bg-primary [clip-path:polygon(0%_0%,100%_0%,60%_100%,0%_100%)]"></div>
</div>	
