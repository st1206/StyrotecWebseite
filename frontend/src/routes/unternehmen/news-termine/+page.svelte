...
<div class="from-primary-foreground   to-secondary h-[100px] bg-gradient-to-b" id="referenzen"></div>

<!-- TODO: Referenzen -->
<div class="bg-secondary h-[800px]" >
...
<div class="from-secondary to-primary-foreground h-[100px] bg-gradient-to-b" id="messen"></div>
