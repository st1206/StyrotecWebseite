...
import type { ApiAnwenderstorieAnwenderstorie, ApiBerichteBerichte, ApiMessenMessen, ApiReferenzenReferenzen } from '$lib/cmsTypes/contentTypes';
...
export const load: PageServerLoad = async ({ fetch, cookies }) => {
    ...
    const loadAnwenderstories = async (): Promise<AttributesOf<ApiAnwenderstorieAnwenderstorie>[]> => {
        const res = await fetch(
